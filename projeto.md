...
|RF-005|RECOMENDAR ITENS|mensagem recomendando um item relacionado as pesquisas recentes|
|RF-006|ENVIAR RECEITAS VIA E-MAIL|permite ao usuário recber receitas através do e-mail cadastrado|
